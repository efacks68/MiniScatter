...
if xPlot:
    ...
    integral = projX_G4_QBERTZ.Integral(projX_G4_QBERTZ.GetXaxis().FindBin(-xlim),projX_G4_QBERTZ.GetXaxis().FindBin(xlim),option="width")
    projX_G4_QBERTZ.Scale(1/integral)
    ...
    print("5 Gaussian Fit X sigma = {:.3f}, {:.3f}, {:.3f}, {:.3f}, {:.3f}, chi2: {:.3e}".format(a5x.GetParameter(1),a5x.GetParameter(3),
                                                                                                a5x.GetParameter(5),a5x.GetParameter(7),
...
integral = projY_G4_QBERTZ.Integral(projY_G4_QBERTZ.GetXaxis().FindBin(-xlim),projY_G4_QBERTZ.GetXaxis().FindBin(xlim))
projY_G4_QBERTZ.Scale(1/integral)
...
canvas.Print(picpath+"Figure4.pdf")
...
with open(picpath+"YFit.csv",mode="w") as csv_file:
    ...
    csv_writer.writerow(["1,{:.1f},{:.1e},{:.2e}".format(a1y.GetParameter(2),a1y.GetParameter(0),a1y_res.Chi2())])
    csv_writer.writerow(["2,{:.1f},{:.1e},{:.1f},{:.1e},{:.2e}".format(a2y.GetParameter(1),a2y.GetParameter(0),
                            a2y.GetParameter(3),a2y.GetParameter(2),a2y_res.Chi2())])
    csv_writer.writerow(["3,{:.1f},{:.1e},{:.1f},{:.1e},{:.1f},{:.1e},{:.2e}".format(a3y.GetParameter(1),a3y.GetParameter(0),
                            a3y.GetParameter(3),a3y.GetParameter(2),a3y.GetParameter(5),a3y.GetParameter(4),a3y_res.Chi2())])
    csv_writer.writerow(["4,{:.1f},{:.1e},{:.1f},{:.1e},{:.1f},{:.1e},{:.1f},{:.1e},{:.2e}".format(a4y.GetParameter(1),
    ...
    csv_writer.writerow(["5,{:.1f},{:.1e},{:.1f},{:.1e},{:.1f},{:.1e},{:.1f},{:.1e},{:.1f},{:.1e},{:.2e}".format(a5y.GetParameter(1),
