...
#G4_EMZ (EMonly_EMZ)
integral = G4_EMZ_TH2.Integral(G4_EMZ_TH2.GetXaxis().FindBin(-xlim),G4_EMZ_TH2.GetXaxis().FindBin(xlim),G4_EMZ_TH2.GetYaxis().FindBin(-xlim),G4_EMZ_TH2.GetYaxis().FindBin(xlim))
...
integral = G4_QFBERTSS_TH2.Integral(G4_QFBERTSS_TH2.GetXaxis().FindBin(-xlim),G4_QFBERTSS_TH2.GetXaxis().FindBin(xlim),G4_QFBERTSS_TH2.GetYaxis().FindBin(-xlim),G4_QFBERTSS_TH2.GetYaxis().FindBin(xlim))
...
proj_MCNP_BERT_Pri.SetTitle(axis+" Scattered Pencil Beam Density at Target")
proj_MCNP_BERT_Pri.GetXaxis().SetRangeUser(-xlim,xlim)
proj_MCNP_BERT_Pri.GetYaxis().SetRangeUser(ylim[0],ylim[1])
##Make Legend Entry!
...
leg.Draw()
c2.Draw()
c2.Print(picpath+"PhysLists_BeamOverlap"+axis+"_TotPriQBZSS"+picFormat) #only one is being drawn.
