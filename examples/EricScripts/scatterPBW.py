...
parser.add_argument("--edgeRaster",action="store_true",  help="Only populate edges of raster")
...
parser.add_argument("--findEdges", action="store_true",  default=False,   help="Computes and prints edges of beam on Raster Images")
